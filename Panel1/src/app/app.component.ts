...
const appBarEnterLeaveAnimation = createEnterLeaveAnimation(
  "appBarEnterLeaveAnimation",
  "var(--gx-navbar-main-height)"
);
const appBarItemEnterLeaveAnimation = createFadeInOutAnimation(
  "appBarItemEnterLeaveAnimation"
);
const skeletonEnterLeaveAnimation = createEnterLeaveAnimation(
  "skeletonEnterLeaveAnimation",
  "auto"
);
...
export class AppComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.app.initApp("Panel1");
    this.app.initTheme("travel_agency_app_mobile");
