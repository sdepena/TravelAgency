...
export class CompositeNavigation {
  ...
  /**
   * Update <comp> stored state for the given action <act>
   * @param act
   * @param componentName 
   * @param comp 
   */
  updateState(act: ActionState, componentName: string, comp: IStateContainer) {
    this.activeState.update(act.iid, comp);
  }
