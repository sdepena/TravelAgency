...
const ImageUpload = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "click-capture", onClick: this.stopPropagation }, h("gx-image", { class: "image-viewer-image", alt: this.alt, autoGrow: this.autoGrow, disabled: this.disabled, height: this.height, invisibleMode: this.invisibleMode, lazyLoad: this.lazyLoad, lowResolutionSrc: this.lowResolutionSrc, scaleType: this.scaleType, src: this.src, width: this.width, highlightable: this.highlightable, onClick: this.clickImageAction }, !this.readonly && (h("div", { class: {
            ...
            : this.getPencilAltSolidSVG())))), h("gx-modal", { class: "action-dialog", ref: el => (this.modal = el) }, h("div", { slot: "header" }, this.modalTitle === null ? document.title : this.modalTitle), h("div", { class: "body-container", slot: "body" }, h("label", { class: "file" }, h("input", { type: "file", onChange: this.fileSelectedAction, ref: el => (this.input = el) }), h("span", { class: "file-custom" }, this.changeButtonText)), h("gx-button", { class: "remove-button", onClick: this.clearImageAction }, this.removeButtonText)), h("div", { slot: "secondary-action" }, h("gx-button", { class: "cancel-button", onClick: this.closeAction }, this.cancelButtonText))))));
    }
