...
const Loading = class {
    ...
    render() {
        ...
        return (h("div", { class: "box", role: "dialog" }, h("div", { class: "gx-lottie-test" }), this.lottiePath ? (h("gx-lottie", { path: this.lottiePath, loop: this.type === "indeterminate", autoPlay: this.type === "indeterminate" })) : (h("div", { class: {
                [this.type]: true,
                loader: true
