...
var ActionSheet = /** @class */ (function () {
    ...
    ActionSheet.prototype.handleItemClick = function (event) {
        var target = event.target;
        if (target.matches("gx-action-sheet-item")) {
            this.opened = false;
        }
    };
    ActionSheet.prototype.handleOnClose = function (e) {
        this.opened = false;
        this.close.emit(e);
    };
    ActionSheet.prototype.handleOnOpen = function (e) {
        this.opened = true;
        this.open.emit(e);
    };
    ActionSheet.prototype.render = function () {
        return (h(Host, null, h("gx-modal", { showHeader: false, opened: this.opened, onClose: this.handleOnClose, onOpen: this.handleOnOpen, onClick: this.handleItemClick }, h("div", { class: "gx-action-sheet", slot: "body" }, h("slot", null)), h("gx-action-sheet-item", { class: "gx-action-sheet-close-item", slot: "body" }, this.closeButtonLabel))));
    };
    Object.defineProperty(ActionSheet.prototype, "element", {
...
export { ActionSheet as gx_action_sheet };
