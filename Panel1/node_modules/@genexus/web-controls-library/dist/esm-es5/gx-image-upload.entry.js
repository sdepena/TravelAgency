...
var ImageUpload = /** @class */ (function () {
    function ImageUpload(hostRef) {
        ...
        this.clickImageAction = function (event) {
        ...
        this.triggerAction = function (event) {
            if (_this.src === "") {
                ...
                _this.modal.opened = true;
            }
            event.stopPropagation();
        };
        this.clearImageAction = function () {
            _this.input.value = "";
            _this.src = "";
            _this.alt = "";
            _this.onImageChanged.emit(null);
            _this.closeAction();
        };
        ...
        this.fileSelectedAction = function () {
            ...
            _this.alt = _this.getFileNameWithoutExtension(file.name);
            ...
            _this.closeAction();
            _this.onImageChanged.emit(file);
        };
    }
    ImageUpload.prototype.stopPropagation = function (event) {
        event.stopPropagation();
    };
    ImageUpload.prototype.getFileNameWithoutExtension = function (fileName) {
    ...
    ImageUpload.prototype.getSearchPlusSolidSVG = function () {
    ...
    ImageUpload.prototype.getPencilAltSolidSVG = function () {
    ...
    ImageUpload.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("div", { class: "click-capture", onClick: this.stopPropagation }, h("gx-image", { class: "image-viewer-image", alt: this.alt, autoGrow: this.autoGrow, disabled: this.disabled, height: this.height, invisibleMode: this.invisibleMode, lazyLoad: this.lazyLoad, lowResolutionSrc: this.lowResolutionSrc, scaleType: this.scaleType, src: this.src, width: this.width, highlightable: this.highlightable, onClick: this.clickImageAction }, !this.readonly && (h("div", { class: {
            ...
            : this.getPencilAltSolidSVG())))), h("gx-modal", { class: "action-dialog", ref: function (el) { return (_this.modal = el); } }, h("div", { slot: "header" }, this.modalTitle === null ? document.title : this.modalTitle), h("div", { class: "body-container", slot: "body" }, h("label", { class: "file" }, h("input", { type: "file", onChange: this.fileSelectedAction, ref: function (el) { return (_this.input = el); } }), h("span", { class: "file-custom" }, this.changeButtonText)), h("gx-button", { class: "remove-button", onClick: this.clearImageAction }, this.removeButtonText)), h("div", { slot: "secondary-action" }, h("gx-button", { class: "cancel-button", onClick: this.closeAction }, this.cancelButtonText))))));
    };
    Object.defineProperty(ImageUpload.prototype, "element", {
...
export { ImageUpload as gx_image_upload };
