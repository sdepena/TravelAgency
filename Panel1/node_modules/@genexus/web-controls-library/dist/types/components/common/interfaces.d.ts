...
export interface FormComponent extends Component, DisableableComponent, VisibilityComponent {
    input: EventEmitter;
    /**
...
export interface RendererConstructor {
    new (component: Component, handlers?: {
        [key: string]: (event: UIEvent) => void;
    }): Renderer;
}
