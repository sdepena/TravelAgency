...
export declare class GridSmartCss implements GridBase, ComponentInterface, VisibilityComponent {
    constructor();
    private CSS_NAME_MOUSE_DRAG_ACTIVE;
    element: HTMLGxGridSmartCssElement;
    /**
     ...
     */
    readonly itemLayoutMode: "single" | "mbyq" | "mbys";
    /**
