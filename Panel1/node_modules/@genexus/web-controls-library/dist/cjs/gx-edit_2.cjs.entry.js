...
class EditRender {
    ...
    render(slots) {
        ...
        let editableElement;
        if (edit.multiline) {
            editableElement = index.h("textarea", Object.assign({}, attris), edit.value);
        }
        else {
            const input = index.h("input", Object.assign({}, attris, { type: edit.type, value: edit.value }));
            if (edit.showTrigger) {
                const existSlotContent = edit.element.querySelector("[slot='trigger-content']");
                editableElement = (index.h("div", { class: "input-group", hidden: edit.readonly },
                    input,
                    index.h("div", { class: "input-group-append" },
                        index.h("button", { class: this.getTriggerCssClasses(), onClick: this.handleTriggerClick, type: "button", disabled: edit.disabled, "aria-label": edit.triggerText }, existSlotContent !== null
        ...
        return [
            index.h("gx-bootstrap", null),
            index.h(ReadonlyTag, { key: "readonly", hidden: !edit.readonly, "data-readonly": "", class: {
                ...
                edit.lineClamp && (index.h("div", { class: "line-measuring", "aria-hidden": true }, "A")),
...
const Edit = class {
    constructor(hostRef) {
        ...
        this.gxTriggerClick = index.createEvent(this, "gxTriggerClick", 7);
        /**
        ...
        lineClamp.makeLinesClampable(this, "[data-readonly]", ".line-measuring");
    }
    /**
    ...
    render() {
        return (index.h(index.Host, { class: {
            ...
            triggerContent: index.h("slot", { name: "trigger-content" })
        })));
    }
...
class FormFieldRender {
    ...
    renderForRadio(renderLabel, renderLabelBefore, slot) {
        ...
        const label = (index.h("div", { class: this.getLabelCssClass(), id: labelId, "data-part": "label" },
            index.h("div", { class: "label-content" }, this.component.labelCaption)));
        ...
        return (index.h("div", { class: "form-group mb-0", "aria-labelledby": labelId, role: "group" },
            index.h("div", { class: {
                    "radio-group": true,
                    "no-gutters": true,
                ...
                index.h("div", { class: this.getInnerControlContainerClass() }, slot),
                renderLabel && !renderLabelBefore ? label : null)));
    }
    render(slots) {
        const formField = this.component;
        ...
        if (isRadioGroup) {
            ...
            const label = (index.h("label", { class: this.getLabelCssClass(), "data-part": "label" },
                index.h("div", { class: "label-content" }, formField.labelCaption)));
            const result = formField.labelPosition === "float" ? (index.h("div", null,
                slots.default,
                label)) : (index.h("div", { class: {
                    "form-group": true,
                    "no-gutters": true,
                    "mb-0": true,
                ...
                renderLabel && renderLabelBefore ? label : null,
                index.h("div", { class: this.getInnerControlContainerClass() }, slots.default),
                renderLabel && !renderLabelBefore ? label : null));
            return [index.h("gx-bootstrap", null), result];
        }
    }
}
...
const FormField = class {
    ...
    render() {
        return this.renderer.render({ default: index.h("slot", null) });
    }
    get element() { return index.getElement(this); }
};
FormField.style = formFieldCss;

exports.gx_edit = Edit;
exports.gx_form_field = FormField;
