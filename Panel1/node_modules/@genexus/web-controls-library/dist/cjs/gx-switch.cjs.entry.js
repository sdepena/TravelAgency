...
class SwitchRender {
    ...
    render() {
        ...
        return [
            ...
            index$1.h("span", { class: "switch switch-sm" },
                index$1.h("input", Object.assign({}, inputAttrs)),
                index$1.h("label", { htmlFor: this.inputId }, switchCmp.caption))
        ];
    }
}
...
const Switch = class {
    ...
    render() {
        return index$1.h(index$1.Host, { role: "switch" }, this.renderer.render());
    }
