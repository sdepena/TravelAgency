...
class CheckBoxRender {
    ...
    render() {
        ...
        return [
            ...
            index$1.h("div", { class: "custom-control custom-checkbox" },
                index$1.h("input", Object.assign({}, attris, { type: "checkbox", checked: checkbox.checked, value: checkbox.checked ? checkbox.checkedValue : checkbox.unCheckedValue })),
                index$1.h("label", Object.assign({ class: "custom-control-label" }, forAttris, { "aria-hidden": (!checkbox.caption).toString() }), checkbox.caption))
        ];
    }
}
