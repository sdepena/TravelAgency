...
class SelectRender {
    ...
    render() {
        if (this.component.readonly) {
            return (index$1.h("span", { class: this.getCssClasses() }, this.getReadonlyTextContent()));
        }
        else {
            let datalistId;
            const attris = {
            ...
            return this.component.suggest
                ? [
                    ...
                    index$1.h("input", { list: datalistId, disabled: this.component.disabled, placeholder: this.component.placeholder, value: this.component.value, onChange: this.handleChange.bind(this) }),
                    index$1.h("datalist", { id: datalistId }, this.options.map(({ innerText, selected, value, disabled }) => (index$1.h("option", { disabled: disabled, selected: selected, value: value }, innerText))))
                ]
                : [
                    index$1.h("gx-bootstrap", null),
                    index$1.h("select", Object.assign({}, attris), this.options.map(({ innerText, selected, value, disabled }) => (index$1.h("option", { disabled: disabled, selected: selected, value: value }, innerText))))
                ];
        }
    }
}
