...
const Tab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { role: "tablist" }, index.h("div", { class: "gx-nav-tabs" }, index.h("slot", { name: "caption" }), index.h("div", { "aria-hidden": "true", class: "gx-nav-tabs-filler" })), index.h("div", { class: "gx-tab-content" }, index.h("slot", { name: "page" })))));
    }
...
const TabCaption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "tab", class: {
                "gx-tab-caption": true,
                "gx-tab-caption--active": this.selected,
                "gx-tab-caption--disabled": this.disabled,
                [imagePosition.imagePositionClass(this.imagePosition)]: true,
                [imagePosition.hideMainImageWhenDisabledClass]: !this.selected && this.hasDisabledImage
            } }, index.h("a", { class: {
                "gx-nav-link": true
            }, href: "#", onClick: this.clickHandler }, imagePosition.imagePositionRender({
            default: index.h("slot", null),
            disabledImage: index.h("slot", { name: "disabled-image" }),
            mainImage: index.h("slot", { name: "main-image" })
        }))));
    }
    clickHandler(event) {
...
const TabPage = class {
    ...
    render() {
        return (index.h(index.Host, { role: "tabpanel", tabindex: "0" }, index.h("slot", null)));
    }
    get element() { return index.getElement(this); }
};
...
exports.gx_tab = Tab;
exports.gx_tab_caption = TabCaption;
exports.gx_tab_page = TabPage;
