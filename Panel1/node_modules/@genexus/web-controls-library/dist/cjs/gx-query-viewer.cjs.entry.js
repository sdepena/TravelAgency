...
const QueryViewer = class {
    ...
    postData() {
        ...
        return [
            ...Object.keys(QueryViewer.prototype)
                ...
                .map(key => index$1.h("input", { type: "hidden", name: key, value: this[key] })),
            index$1.h("input", { type: "hidden", name: "Elements", value: this.elements }),
            index$1.h("input", { type: "hidden", name: "Parameters", value: this.parameters })
        ];
    }
    getParameters() {
    ...
    render() {
        return (index$1.h(index$1.Host, null, index$1.h("iframe", { name: "query_viewer", "data-version-id": this.dataVersionId }), index$1.h("form", { hidden: true, target: "query_viewer", action: this.baseUrl + this.mapServices[this.env], method: "POST" }, this.postData())));
    }
    get element() { return index$1.getElement(this); }
};
QueryViewer.style = queryViewerCss;

exports.gx_query_viewer = QueryViewer;
