...
function publishCall(fnName, options, resolver) {
    var params = [];
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    ...
                    var suscriptions = options.map(function (opt) {
                        var s = pubSub_1.subscribe(helpers_1.stdToGeneratorPublishedMessage + "_" + fnName + "_" + guid + "_" + opt, function (result) {
                            unsubscribe();
                    ...
                    pubSub_1.publish.apply(void 0, __spreadArrays([helpers_1.stdToGeneratorPublishedMessage + "_" + fnName, guid], params));
                })];
        });
    });
}
