 ...
 */
exports.publish = function (topicName) {
    var data = [];
 ...
 */
exports.subscribe = function (topicName, handler, options) {
 ...
 */
exports.cancelTopic = function (topicName) {
 ...
 * @param suscription The suscription object
 */
exports.cancelSubscription = function (subscription) {
    subscription.unsubscribe();
};
/**
 * Clears all subscribed events.
 */
exports.cancelAllSubscriptions = function () {
