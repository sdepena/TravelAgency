 ...
 * @return any
 */
export var setBadgeText = function (text, tabIndex) { return __awaiter(void 0, void 0, void 0, function () {
    var resolver;
    return __generator(this, function (_a) {
        resolver = function (opt, value, resolve) {
            return resolve();
        };
        return [2 /*return*/, publishCall("iOSSetBadgeTextToTabIndex", ["ok"], resolver, text, tabIndex)];
    });
}); };
