...
export function publishCall(fnName, options, resolver) {
    var params = [];
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    ...
                    var suscriptions = options.map(function (opt) {
                        var s = subscribe(prefix + "_" + fnName + "_" + guid + "_" + opt, function (result) {
                            unsubscribe();
                    ...
                    publish.apply(void 0, __spreadArrays([prefix + "_" + fnName, guid], params));
                })];
        });
    });
}
