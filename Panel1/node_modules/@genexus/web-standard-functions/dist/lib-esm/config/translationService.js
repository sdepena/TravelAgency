...
var TranslationService = /** @class */ (function () {
    ...
    TranslationService.prototype.translate = function (name, language) {
        ...
        var lang = language !== undefined ? language : getLanguage();
    ...
    TranslationService.prototype.getImageSource = function (name, language, theme) {
        var lang = language ? language : getLanguage();
        var imageUrl = name;
    ...
    TranslationService.prototype.getHostName = function () {
        var hostName = ConfigurationState.getInstance().getDynStoredValue("SERVICE_HOSTNAME");
        if (hostName) {
            return hostName;
        }
        else {
